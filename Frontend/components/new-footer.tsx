  ...
  return (
    <footer className="bg-gradient-to-br from-[#2c4a61ff] to-[#a0c7e0ff] text-white py-10">
      <div className="max-w-6xl mx-auto px-6 text-center">
        {/* Title */}
        <h2 className="text-3xl md:text-4xl font-bold mb-4">Mesob</h2>

        {/* Description */}
        <p className="text-white/80 max-w-xl mx-auto mb-8 text-base leading-relaxed">
          Mesob connects public institutions to share data quickly and safely. We help improve communication, reduce paperwork, and support better public services.
        </p>
        ...
        <p className="text-white/60 text-sm">
          &copy; {new Date().getFullYear()} Mesob. All rights reserved.
        </p>
      </div>
    </footer>
  );
